...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT- The error was caused because were declaring rando within the function displayPics and then attempting to console log outside of the function.  The let declaration is locally scoped and will not be recognized outside of its containing function.
  console.log(viewed);
